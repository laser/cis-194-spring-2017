...
spec = do
  ...
  describe "hanoi" $ do
    ...
    it "should solve for 2 discs" $
      hanoi 2 "a" "b" "c" `shouldBe` [("a", "c"), ("a", "b"), ("c", "b")]

    it "should solve for 3 discs" $
      hanoi 3 "a" "b" "c" `shouldBe` [("a", "b"), ("a", "c"), ("b", "c"), ("a", "b"), ("c", "a"), ("c", "b"), ("a", "b")]

    it "should have the correct number of moves for 4 discs" $
      length (hanoi 4 "a" "b" "c") `shouldBe` 15

    it "should have the correct number of moves for 5 discs" $
      length (hanoi 5 "a" "b" "c") `shouldBe` 31

    it "should have the correct number of moves for 6 discs" $
